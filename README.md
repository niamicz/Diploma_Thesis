...
/simulation – Numerické simulace aerodynamického stínění věží (metoda LBM).  

/data – Ukázkové soubory naměřených dat z terénních a laboratorních testů.  

/docs – Schémata zapojení a fotodokumentace prototypu.  
